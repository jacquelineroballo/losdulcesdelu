        ...
        <motion.div className="container px-4 md:px-6 relative z-10" style={{ opacity, scale, y }}>
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4">
              ...
              >
                Delicias <span className="font-display gradient-text sparkle">Personalizadas</span> para Cada Ocasión
              </motion.h1>
              ...
              >
                Transformamos ingredientes simples en obras de arte comestibles. Satisface tus antojos con nuestros
                pasteles y dulces irresistibles.
              </motion.p>
            ...
            >
              <Card3D className="w-full">
                ...
                >
                  ...
                  <p className="text-sm">"¡La mejor pastelería de la ciudad! Todos amaron mi torta de cumpleaños."</p>
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <FadeIn>
            <div className="grid gap-6 text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-4xl font-bold tracking-tighter md:text-5xl/tight gradient-text">Por qué elegirnos</h2>
              <p className="text-xl text-muted-foreground">
                En Los dulces de Lu, cada creación es única y especial, hecha con amor e ingredientes de calidad
              </p>
            </div>
          </FadeIn>
                ...
                <div className="relative overflow-hidden py-8">
                  <div className="relative flex items-center">
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      >
                        <blockquote className="text-xl italic">"{testimonials[slideIndex].text}"</blockquote>
            ...
            <FadeIn direction="right" delay={0.2}>
              <Card3D className="relative h-[400px] overflow-hidden rounded-lg">
                ...
                >
                  ...
                  <p className="text-sm text-white">"Sus pasteles son obras de arte que saben tan bien como se ven."</p>
          ...
          <div className="grid gap-10 lg:grid-cols-2 items-center">
            <FadeIn direction="left">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground">
                  Da el primer paso hacia la satisfacción dulce: realiza tu pedido o suscríbete a nuestro boletín para
                  recibir actualizaciones y promociones.
                </p>
              </div>
            </FadeIn>
